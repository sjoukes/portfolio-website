  ...
  fr: {
    projectsContent: {
      sampleProject: {
        ...
        detailedDescription: "Une description plus détaillée de ce projet d'exemple, montrant comment structurer le contenu pour la page de détail du projet.",
        keyFeatures: {
          responsiveDesign: {
          ...
          contentManagement: {
            ...
            description: "Permet une gestion aisée du contenu via des fichiers Markdown ou un CMS."
          }
        },
        galleryImages: {
        ...
        challenges: "Description des défis rencontrés lors de la création de ce projet exemple.",
    ...
    skillsContent: {
      frontendDevelopment: {
        ...
        description: "Création d'interfaces utilisateur interactives et performantes."
      },
      backendDevelopment: {
    ...
    site: {
      ...
      description: "Un template Astro moderne et performant pour démarrer votre projet."
    },
    nav: {
      home: "Accueil",
      blog: "Blog",
    ...
    homePage: {
      ...
      pageDescription: "Bienvenue sur le portfolio de YOUR_NAME, développeur FullStack passionné par la création d'expériences web innovantes.",
      ...
      heroImageAlt: "Illustration représentant YOUR_NAME ou un concept de développement",
      featuredProjectsTitle: "3 derniers projets",
      featuredProjectsDescription: "Voici quelques projets sur lesquels j'ai récemment travaillé. N'hésitez pas à les explorer !",
    ...
    blogPage: {
      ...
      pageDescription: "Articles et réflexions sur le développement web, l'architecture logicielle, et les nouvelles technologies.",
      title: "Mon Blog Technique",
      description: "Articles et réflexions sur le développement web, l'architecture logicielle, et les nouvelles technologies.",
      comingSoon: "Les articles de blog apparaîtront ici bientôt. Revenez plus tard !",
    ...
    contactPage: {
      ...
      pageDescription: "Discutons de ton projet, d'une collaboration potentielle, ou simplement pour échanger sur la tech !",
      title: "Me Contacter",
      description: "Discutons de ton projet, d'une collaboration potentielle, ou simplement pour échanger sur la tech !",
      ...
      calendarDescription: "Tu préfères discuter de vive voix ? Réservez directement un créneau dans mon agenda.",
      calendarButtonLabel: "Voir mes disponibilités",
      calendarLinkLabel: "Voir mon agenda",
      calendarPlaceHolder: "L'intégration avec Google Calendar se fera bientôt...",
      orSeparatorText: "OU",
    ...
    projectsPage: {
      ...
      noProjectsDescription: "Il semble que vous n'ayez pas encore de projets à afficher."
    },
    notFoundPage: {
      pageTitle: "Page Non Trouvée",
      title: "Oups ! Page Non Trouvée",
      message: "Désolé, la page que vous recherchez ne semble pas exister. Vérifiez l'URL ou retournez à la page d'accueil.",
      homeLink: "Retourner à l'Accueil"
    },
    tipsPage: {
      metaTitle: "Astuces de Développement",
      metaDescription: "Découvrez des astuces et conseils rapides sur le développement web et la cloud computing.",
      description: "Découvrez des astuces et conseils rapides sur le développement web et la cloud computing.",
    ...
    zodErrors: {
      ...
      invalid_type_received_undefined: "Ce champ est requis.",
